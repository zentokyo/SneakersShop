...
<template>
    <header class="py-10">
        <nav class="flex flex-col sm:flex-row gap-4 items-center sm:h-10 px-5 sm:px-10 justify-between">
            <router-link to="/" class="flex gap-2">
                <img src="/logo.png" alt="logo" class="w-10 h-10">
                <div>
                    <h2 class="font-bold text-xl/">REACT SNEAKERS</h2>
                    <p class="text-sm font-normal text-">Магазин лучших кроссовок</p>
                </div>
            </router-link>
            <div class="w-screen h-px sm:w-0 sm:h-0 bg-zinc-300"></div>

            <ul class="flex gap-4 sm:gap-8">
                <li>
                    <router-link to="" class="flex gap-2 group" @click="$emit('openCart')">
